! function() {
	var citys = [{
		"n": "北京",
		"c": [{
			"a": ["密云区","朝阳区","昌平区","平谷区","海淀区","西城区",
			"东城区","崇文区","宣武区","丰台区","石景山区","门头沟","房山区",
			"通州区","延庆县","大兴区","顺义区","怀柔区","其它区"],
			"n": "北京市"
		}]
		}, {
		"n": "上海",
		"c": [{
			"a": ["静安区","闸北区","虹口区","杨浦区","宝山区",
			"闵行区","嘉定区","浦东新区","青浦区","松江区","金山区","奉贤区",
			"普陀区","黄浦区","崇明县","徐汇区","长宁区","其它区"],
			"n": "上海市"
		}]
	}, {
		"n": "天津",
		"c": [{
			"a": ["东丽区","和平区","河北区","河东区","河西区","红桥区",
			"蓟县","静海县","南开区","塘沽区","西青区","武清区","津南区",
			"汉沽区","大港区","北辰区","宝坻区","宁河县","其它区"],
			"n": "天津市"
			}]
			}, {
		"n": "重庆",
		"c": [{
			"a": ["江北区","璧山县", "荣昌区", "铜梁县", "南岸区", "九龙坡区", "沙坪坝区",
			 "大渡口区", "綦江区", "合川区", "巴南区", "北碚区", "江津区", "渝北区", "长寿区",
			 "永川区","渝中区","高新区","北部新区","大足区","万州区","涪陵区","梁平县","南川区","潼南县",
			 "黔江区","开县","云阳县","忠县","垫江县","城口县","武隆县","丰都县","奉节县","巫溪县","巫山县",
			 "石柱县","彭水县","酉阳县","秀山县","其它区"],
			 "n": "重庆市"
			 }]
			 }, {
		...
		"c": [{
			...
			"a": ["姑苏区","常熟市", "张家港市", "太仓市", "相城区", "金阊区", "虎丘区", "平江区", "沧浪区", "工业园区", "高新区", "吴江区", "吴中区", "昆山市"],
			"n": "苏州市"
		}]
	}, {
		"n": "山东",
