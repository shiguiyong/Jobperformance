...
<body>
<div  style="width:33.33%;height:auto;background:#f2f2f2;margin:10px;position:relative;float:left;border-radius:5px">
    <div style="margin-left:10px;margin-top:10px" id="emolument">
        ...
        <div>
            <div style="width:25%;text-align: center;float: left;margin-top: 10px;">
                <span style="color:#66CC66;"> 基本工资</span>
                <p style="font-size:12px;">${employees.basic}</p>
            </div>
            <div style="width:25%;text-align: center;float: left;margin-top: 10px;">
                <span style="color:#66CC66"> 绩效基数</span>
                <p style="font-size:12px;">${employees.performance}</p>
            </div>
            <div style="width:25%;text-align: center;float: left;margin-top: 10px;">
                <span style="color:#66CC66"> 绩效比例</span>
                <p style="font-size:12px;">
                 <fmt:formatNumber type="percent" value="${employees.performancepercent}" maxFractionDigits="3"  />
              </p>
            </div>
            <div style="width:25%;text-align: center;float: left;margin-top: 10px;">
                <span style="color:#66CC66"> 预计绩效</span>
                <p style="font-size:12px;">${employees.yuperformance}</p>
            </div>
            <div style="width:25%;text-align: center;float: left;margin-top: 10px;">
                <span style="color:#66CC66"> 全勤奖励</span>
                <p style="font-size:12px;">${employees.present}</p>
            </div>
            <div style="width:25%;text-align: center;float: left;margin-top: 10px;">
                <span style="color:#66CC66"> 出勤扣减</span>
                <p style="font-size:12px;">${employees.reducepresent}</p>
            </div>
            <div style="width:25%;text-align: center;float: left;margin-top: 10px;">
                <span style="color:#66CC66"> 提成</span>
...
<div style="width:31%;height:300px;background:#f2f2f2;margin:10px;position:relative;float:left;border-radius:5px">
    <div style="margin-left:10px;margin-top:10px">
        <span style="color:#0099ff;font-weight:800;font-size:14px">丨</span>
        <span style="font-size:14px">薪资概览</span>
    </div>
</div>
<div style="width:31%;height:auto;background:#f2f2f2;margin:10px;position:relative;float:left;border-radius:5px">
    <div style="margin-left:10px;margin-top:10px">
        <span style="color:#0099ff;font-weight:800;font-size:14px">丨</span>
        ...
        <p style="font-size: 12px;">4.薪资的30%(或以额外约定为准)将作为绩效基数；低于90%的完成率将作为系数体现在绩效基数上，可通过系统实时查看当月完成率；</p>
