...
<table style="overflow-x: auto;height:auto;margin-top:5px;" class="layui-table">
    ...
    <tr>
        ...
        <th nowrap width="185px">绩效比例</th>
        <th nowrap width="185px">预计绩效</th>
        <th nowrap width="185px">全勤奖励</th>
        <th nowrap width="185px">出勤扣减</th>
        <th nowrap width="185px">提成</th>
    </tr>
    </thead>
    <tbody id="tb">
    </tbody>
...
<script type="text/javascript">
    ...
    function searchPage(pageNum) {
        ...
        $.ajax({
            type : "POST",
            dataType : "json",
            url : "${pageContext.request.contextPath}/emp/billsheetAjax?pageNum="+pageNum+"",
            ...
            success : function(data) {
                ...
                $.each(data.list,function(index, list){
                    ...
                    var pppp = toPercent(list.performancepercent);
                    str+='<td nowrap>'+pppp+'</td>';
                    str+='<td nowrap>'+list.yuperformance+'</td>';
                    str+='<td nowrap>'+list.present+'</td>';
                    str+='<td nowrap>'+list.reducepresent+'</td>';
                    str+='<td nowrap>'+list.addwork+'</td>';
                    str+='</tr>';
...
<script type="">
    function toPercent(point){
        ...
        var str;
        var number= point*10000%100;
        if(number==0){
            str=Number(point*100).toFixed();
        }else {
