...
<table style="overflow-x: auto;height:auto;margin-top:5px;" class="layui-table">
    ...
    <tr>
       ...
       <%-- <th >
        ...
        <th nowrap >操作</th>
        <th nowrap width="155px">月份</th>
        <th nowrap width="155px">名称</th>
        <th nowrap width="155px">正常天数</th>
        <th nowrap width="155px">迟到次数</th>
        <th nowrap width="155px">早退次数</th>
...
<script type="text/javascript">
    ...
    function searchPage(pageNum) {
        ...
        $.ajax({
            type : "POST",
            dataType : "json",
            url : "${pageContext.request.contextPath}/flow/queryAllAttendance?pageNum="+pageNum+"",
...
*/
                    str+='<td nowrap><a class="bj-btn" onclick="lookdetails(\''+list.serialnumber+'\')" >查看详情</a></td>';
                    str+='<td nowrap style="text-align: center"><a class="bj-btn"  >'+list.datevar+'月份</a></td>';
                    str+='<td nowrap style="text-align: center"><a class="bj-btn" >'+list.name+'</a></td>';
                   if(list.normalnum == null){
                       str+='<td nowrap >0</td>';
                   }else {
                       str+='<td nowrap >'+list.normalnum+'</td>';
                   }

                    if(list.latenum == null){
                        str+='<td nowrap >0</td>';
                    }else {
                        str+='<td nowrap >'+list.latenum+'</td>';
                    }
                    if(list.earlynum == null){
                        str+='<td nowrap >0</td>';
                    }else {
                        str+='<td nowrap >'+list.earlynum+'</td>';
                    }
                    if(list.lateminute == null){
                        str+='<td nowrap >0</td>';
                    }else {
                        str+='<td nowrap >'+list.lateminute+'</td>';
                    }

                    if(list.moreminute == null){
                        str+='<td nowrap >0</td>';
                    }else {
...
<script type="text/javascript">
    ...
    function lookdetails(idnum) {
        layer.open({
            ...
            content: '${pageContext.request.contextPath}/jsp/jobtask/attendancedetails.jsp?idnum='+idnum,
        });
    }
